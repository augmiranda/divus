...
if($_GET){
  ...
  if(!empty($usuario)){
    ...
    $alerts[] = ['type' => 'danger' , 'message' => "Usuário inexistente!"];
  }
}
...
if($_POST){
  ...
  if(count($alerts) == 0){
    ...
    if($success){
      $alerts[] = ['type' => 'success' , 'message' => "Usuário alterado com sucesso!"];
    }
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        ?>
          ...
          <h1>Usuário <small>alterar</small></h1>
          ...
          <form method="POST" class="form-horizontal">
            ...
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                ...
                <a href="usuario_listar.php" class="btn btn-info">Voltar</a>
              </div>
            </div>
          </form>
